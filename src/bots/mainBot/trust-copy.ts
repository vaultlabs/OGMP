...
export const PREMIUM_WELCOME = [
  "━━━━━━━━━━━━━━━━━━",
  "<b>OGMP MM</b> — Secure Middleman",
  "━━━━━━━━━━━━━━━━━━",
  "",
  "<b>What</b>  Escrow deals — upload → pay → unlock → release",
  "<b>Safe</b>  Funds in escrow · files in Delivery Vault until paid",
  "<b>Next</b>  Create or join a deal below",
  "",
  COMMUNITY_TRUST_LINE,
  "",
  "Vault → Pay → Unlock → Review → Release",
  "",
  TRUST_OPS_FOOTER,
].join("\n");
...
export const DEAL_PROTECTION_BEFORE_PAY = [
  "━━━━━━━━━━━━━━━━━━",
  "<b>OGMP MM</b> — Deal Protection",
  "━━━━━━━━━━━━━━━━━━",
  "",
  "<b>What</b>  Pay escrow to unlock the Delivery Vault",
  "<b>Safe</b>  Seller is not paid until you confirm release",
  "<b>Next</b>  Send the <b>exact</b> amount on the next screen",
  "",
  "⚠️ Too little or too much can mean <b>lost funds</b>.",
  "Use only this deal’s coin and network. Never pay outside OGMP MM.",
  "",
  TRUST_OPS_FOOTER,
].join("\n");
